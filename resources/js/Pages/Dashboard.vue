            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 ">
                <header class="bg-white shadow sm:rounded-lg mb-6">
                    <div class=" py-6 px-4 sm:px-6 lg:px-8">
                        <h2 class="font-semibold text-xl text-gray-800 leading-tight"> Sended Emails </h2>
                    </div>
                </header>
                            ...
                            <table class="min-w-full table-auto">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="px-4 py-2 text-left border-b">Recipients</th>
                                ...
                                <tbody>
                                    <tr class="*:px-2" v-for="(email, index) in sentEmails.data" :key="email.id">
                                        <td>{{ index + 1 }}</td>
                    ...
                    <div class="flex justify-end flex-wrap -mb-1">
                        <template v-for="(link, key) in sentEmails.links">
                            ...
                            <inertia-link v-else :key="label"
                                class="mr-1 mb-1 px-4 py-3 text-sm leading-4 border rounded hover:bg-blue-600 focus:border-indigo-500 focus:text-indigo-500"
